			...
			<div className="container px-5 py-10 mx-auto text-center lg:px-40">
				...
				<InformationCircleIcon className="mx-auto inline-block w-10 mb-4" />
					...
					<p className="mb-8 leading-relaxed">
						Minor Mischief is a development organization under which I, Josh Brooks, work on projects in my free time. I have taken up several small projects ranging from mobile applciations to virtual reality games.
					</p>
